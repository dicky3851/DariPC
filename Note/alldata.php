	...
	<div class="basicFrame backgroundGray">
		...
		<div class="col100 backgroundWhite padding15 marginBottom10">
			...
			<div class="col100 marginTop20">
				<form name="form_1" action="alldata.php" method="post" onsubmit="return validate_form1()">
			...
			<div class="col100 backgroundWhite padding15">
				<div class="col98 marginAuto marginBottom20 borderBottomColorGrey2 paddingBottom10">
					...
					<div class="floatRight marginRight20 textRight">
						<img src="images/excel-icon.png" class="imgExport" onclick="window.open('excelmapping.php<?php echo "?date1=".$_SESSION['date1']."&date2=".$_SESSION['date2']."&type=All&field=".$field."&idVendorC=".$idVendorC ?>','_blank')">
					</div>
				...
				{
					$queryD = $queryD." and (MID like '%".$_SESSION['field']."%' or TID like '%".$_SESSION['field']."%'
					or mrchnt_name like '%".$_SESSION['field']."%')";
				}

				// $queryD = $queryD." order by idPm asc";
				...
				<div class="table-responsive">
					...
					while($rowD = mysql_fetch_array($resultD))
					{
						...
						?>
						<tr>
							<td class="viewData fontSize085 textCenter linkClick colorBlue" onclick="window.open('datadetailall.php<?php echo "?idPm=".$idPm ?>','_blank')">
								<?php echo $rowD['MID'] ?>
							</td>
